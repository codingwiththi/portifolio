    ...
    return (
        <>
            <section
                id="about"
                title="about"
                className="border-t border-double border-thi2"
            >
                <p>
                    -------------------------------------------------------------------------------------
                </p>
                ...
                <div className="container mx-auto px-6 py-20 bg-gray-900">
                    <main
                        id="resume"
                        className="flex flex-row bg-white h-screen"
                    >
                        <div className="flex-col w-2/3">01</div>
                        <div className="flex-col w-1/3 bg-gradient-to-b from-thi3 via-thi2 to-thi1">
                            02
                        </div>
                    </main>
                </div>
                    ...
                    >
                        ...
                        <div className="content w-full p-12">
                            <div id="profile" className="prose">
                                ...
                                <p>
                                    I'm a self-taught web developer focusing on
                                    the core web fundamentals - HTML, CSS and
                                    JS. I'm experienced in frontend frameworks
                                    like Vue and React and static site
                                    generators like Next.js and Eleventy. I
                                    write SCSS or use CSS frameworks like
                                    TailwindCSS, Bootstrap or Bulma to speed up
                                    styling of my projects.
                                </p>
                                <p>
                                    I am highly motivated in expanding my
                                    horizons day by day for better performance,
                                ...
                                <div className="mb-16">
                                    ...
                                    <section className="mb-6">
                                        ...
                                        <div className="lg:inline-block lg:w-8/12 w-full">
                                            ...
                                            presence. Here, I share posts about
                                            what I've learnt, tutorials and my
                                            thoughts on web development in
                                            general.
                                        </div>
                                    </section>
                                    <section className="mb-6">
                                    ...
                                    <section className="mb-6">
                                        ...
                                        <div className="lg:inline-block lg:w-8/12 w-full">
                                            <ul>
                                                ...
                                                <li>
                                                    Blog content written in
                                                    Markdown
                                                </li>
                                                <li>
                                                    Counter for pageviews and
                                                    likes
                                                </li>
                            ...
                            <div id="projects" className="prose">
                                ...
                                <div className="mb-16">
                                    <h4 id="expand-knowledge-headline">
                                        I'd like to expand my skills and
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Prototyping and Wireframing, e.g.
                                            with Figma, Adobe XD
                                        </li>
