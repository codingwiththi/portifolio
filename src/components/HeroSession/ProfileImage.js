    ...
    return (
        <div className=" min-h-screen lg:flex flex-1 justify-center items-center  ">
            <div className="relative w-full max-w-lg px-16">
                ...
                <div className="absolute top-0 -left-4 w-72 h-72 bg-thi3 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob z-10"></div>
                <div className="absolute top-0 right-10 w-72 h-72 bg-thi2 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000 z-10"></div>
                ...
                <div className="absolute -bottom-8 left-20 w-72 h-72 bg-green-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000 z-10"></div> */}
